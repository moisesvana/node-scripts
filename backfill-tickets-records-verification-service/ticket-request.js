...
const TYPE_VALUE = "TICKET_REQUEST";
  ...
  do {
    ...
    try {
      ...
      for (const ticket of data.Items) {
        ...
        const newTicketItem = {
          ...ticket,
          pk: `${NEW_ENTITY_TYPE}|${ticketId}`,
          sk: `${ticket.sk.replace("TICKET_REQUEST", NEW_ENTITY_TYPE)}`,
          search: `IDENT|${loanRequestId || ticketId}`,
          type: NEW_ENTITY_TYPE,
        };

        console.log("\n");
        console.log("newTicketItem", JSON.stringify(newTicketItem));
        console.log("\n");
